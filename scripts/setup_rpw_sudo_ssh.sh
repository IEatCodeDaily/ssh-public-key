...
if [ -z "$BASH_VERSION" ]; then
    ...
    echo ""
    echo "  curl -s https://raw.githubusercontent.com/IEatCodeDaily/ssh-public-key/main/scripts/setup_rpw_sudo_ssh.sh | sudo bash"
    echo ""
    echo "  wget -O- https://raw.githubusercontent.com/IEatCodeDaily/ssh-public-key/main/scripts/setup_rpw_sudo_ssh.sh | sudo bash"
    echo ""
